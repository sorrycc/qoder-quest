...
const DICT = {
  ...
  takeHome: { zh: '扫码把落地页带回家', en: 'Scan to take your landing page home' },
  takeHomeHint: { zh: '手机扫一扫就能打开，链接一直有效，发给朋友也行', en: 'Opens on your phone. The link keeps working, so share it if you like' },
  takeHomeCard: { zh: '📱 成品可扫码带回家', en: '📱 Take your page home by QR code' },
  takeHomeButton: { zh: '📱 带回家', en: '📱 Take home' },
  previewQr: { zh: '手机扫码看', en: 'QR code' },
  previewQrHint: { zh: '手机扫码打开。页面再改，刷新一下就是最新的，链接不变', en: 'Scan to open on your phone. Change the page and a reload shows the latest. The link stays the same' },
  showcase: { zh: '作品墙', en: 'Showcase' },
  showcaseEmpty: { zh: '还没有人做出落地页', en: 'Nobody has built a landing page yet' },
  showcaseOpen: { zh: '打开', en: 'Open' },
  showcaseQr: { zh: '二维码', en: 'QR code' },
  showcaseDelete: { zh: '删除', en: 'Delete' },
  showcaseConfirmDelete: { zh: '删掉这个作品？扫过码的人也会打不开', en: 'Delete this page? People who scanned its code lose it too' },
  showcaseUnfinished: { zh: '未通关', en: 'not cleared' },
